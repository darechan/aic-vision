  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-purple-400 mt-1 text-sm">{meta.subtitle}</p>
      </div>

      {loading ? (
        <div className="text-center py-20 text-gray-400 dark:text-purple-700 text-sm">Loading resources…</div>
      ) : resources.length === 0 ? (
        <div className="text-center py-20">
          <p className="text-gray-400 dark:text-purple-400 text-sm">No resources yet. Check back soon!</p>
        </div>
      ) : (
